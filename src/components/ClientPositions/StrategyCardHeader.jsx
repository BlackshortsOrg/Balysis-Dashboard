...
export default function StrategyCardHeader({ name, setShow, show, realizedpnl, unrealizedpnl, numpositions }) {
    ...
    <div className="mx-12 bg-white mt-8 rounded-md shadow-md">
      ...
      <div className="mx-8 flex flex-row pb-4">
        ...
        <div className="basis-1/6">
          <button className="flex flex-row border border-[#41AFFF] text-[#41AFFF] px-8 py-2" onClick={() => setShow(!show)}>
            ({numpositions}) Positions
            <svg className="scale-150" width="20" height="20" viewBox="-9 -4 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4.18179 6.18181C4.35753 6.00608 4.64245 6.00608 4.81819 6.18181L7.49999 8.86362L10.1818 6.18181C10.3575 6.00608 10.6424 6.00608 10.8182 6.18181C10.9939 6.35755 10.9939 6.64247 10.8182 6.81821L7.81819 9.81821C7.73379 9.9026 7.61934 9.95001 7.49999 9.95001C7.38064 9.95001 7.26618 9.9026 7.18179 9.81821L4.18179 6.81821C4.00605 6.64247 4.00605 6.35755 4.18179 6.18181Z" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
          </button>
        </div>
      </div>
    </div>
